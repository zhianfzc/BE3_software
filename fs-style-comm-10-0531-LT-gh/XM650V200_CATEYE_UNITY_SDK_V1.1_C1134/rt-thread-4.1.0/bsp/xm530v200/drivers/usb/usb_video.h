...
#define VIDEO_GUID_H265 0x48, 0x32, 0x36, 0x35, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0xAA, 0x00, 0x38, 0x9B, 0x71

// clang-format off
#define VIDEO_VC_DESCRIPTOR_INIT(bFirstInterface, bNumEndpoints, bcdUVC, wTotalLength, dwClockFrequency, stridx, terminal_control, process_control)                                                                   \
    ...
    0x03,                    /* bControlSize */                                                                                                                                    \
	terminal_control & 0xff, (terminal_control >> 8) & 0xff, (terminal_control >> 16) & 0xff,        /* bmControls */                                                              \
    0x0b,                                                                                                                                                                          \
    0x24,                                                                                                                                                                          \
    ...
    0x02,       /* bControlSize   */                                                                                                                                               \
	process_control & 0xff, (process_control >> 8) & 0xff, /* bmControls */                                                                                                        \
    0x00,       /* iProcessing */                                                                                                                                                  \
	0x09,                                                                                                                                                                          \
    0x24,                                                                                                                                                                          \
...
#define VIDEO_VC_DESCRIPTOR_INIT_EXTENSION_UNIT(bFirstInterface, bNumEndpoints, bcdUVC, wTotalLength, dwClockFrequency, stridx, terminal_control, process_control)                                \
    /* Interface Association Descriptor */                                                                                                                                         \
    0x08,                                                                                                                                                                          \
    USB_DESCRIPTOR_TYPE_INTERFACE_ASSOCIATION,                                                                                                                                     \
    bFirstInterface,                                                                                                                                                               \
    ...
    0x1B,                                                                                                                                                                          \
    0x24,                                                                                                                                                                          \
    VIDEO_VC_EXTENSION_UNIT_DESCRIPTOR_SUBTYPE,                                                                                                                                   \
    0x04,       /* bUnitID  */                                                                                                                                                     \
    0xAA, 0xAA, 0xAA, 0xAA, 0x10, 0x12, 0x10, 0x12, 0x10, 0x12, 0xAA, 0xAA, 0x55, 0x55, 0x55, 0x55,         \
    0x04,                                                                                                   \
    0x01,                                                                                                   \
    0x02,                                                                                                   \
    0x02,                                                                                                   \
...
/* ADD FORMAT  */
#define VIDEO_VS_FORMAT_H265_DESCRIPTOR_INIT(bFormatIndex, bNumFrameDescriptors, GUIDFormat)																	  \
	/*Payload Format(H265 Descriptor */																															  \
    0x1c,                                                                                                                                                         \
    0x24,                                                                                                                                                         \
    VIDEO_VS_FORMAT_FRAME_BASED_DESCRIPTOR_SUBTYPE,	 /* bDescriptorSubType : BASED subtype */																	  \
    bFormatIndex,                                    /* bFormatIndex : First (and only) format descriptor */                                                      \
    bNumFrameDescriptors,                            /* bNumFrameDescriptors : One frame descriptor for this format follows. */                                   \
    GUIDFormat,                                      /* GUID Format H265 {32363248-0000-0010-8000-00AA00389B71} */                                                \
    0x10,                                            /* bBitsPerPixel : Number of bits per pixel used to specify color in the decoded video frame - 16 for yuy2*/ \
    0x01,                                            /* bDefaultFrameIndex : Default frame index is 1. */                                                         \
    0x00,                                            /* bAspectRatioX : Non-interlaced stream not required. */                                                    \
    0x00,                                            /* bAspectRatioY : Non-interlaced stream not required. */                                                    \
...
#define VIDEO_VS_FRAME_H265_DESCRIPTOR_INIT(bFrameIndex, wWidth, wHeight, dwMinBitRate, dwMaxBitRate,           \
																   dwDefaultFrameInterval, dwFrameInterval)		\
    0x1e,                                                                                                           \
    0x24,                                                                                                           \
    VIDEO_VS_FRAME_FRAME_BASED_DESCRIPTOR_SUBTYPE,																	\
    bFrameIndex,																									\
	0x00,																											\
    WBVAL(wWidth),                                                                                                  \
    WBVAL(wHeight),                                                                                                 \
	...
	DBVAL(0x00),					/*  bFrameIntervalType */														\
	DBVAL(dwFrameInterval)			/* adwFrameInterval[1]  */
