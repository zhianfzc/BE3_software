...
const ISP_CMOS_SHARPEN_S gstSharpen_sc202cs = {
	...
	/* Ud*/
	{0x80,0x78,0x70,0x60,0x50,0x50,0x50,0x50,0x50,0x50,0x50,0x50,0x50,0x50,0x50,0x50},
	/* D*/
	...
	{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
	/*EdgeStr*/
	{0x20,0x20,0x20,0x20,0x1c,0x14,0x10,0x0c,0x0c,0x0c,0x0c,0x0c,0x0c,0x0c,0x0c,0x0c},
	/*EdgeThr*/
	{0x04,0x05,0x06,0x08,0x08,0x08,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10},
	/*OverShoot*/
...
static const ISP_U16 gau16SharpTab_sc202cs[][32] = {
	// Edge
	{64, 96, 256, 256, 512, 512, 256, 192, 128, 64, 32, 
	16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 
	16, 16, 16, 16, 16, 16, 16, 16, 16, 16},
	// Text
	{16, 128, 512, 512, 256, 128, 128, 128, 128, 128, 128, 
	128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 
	128, 128, 128, 128, 128, 128, 128, 128, 128, 128},
	// Lum
	{256, 256, 256, 256, 256, 256, 216, 208, 200, 192, 184, 
	176, 168, 160, 152, 144, 120, 96, 96, 96, 88, 80, 
	72, 64, 56, 48, 40, 32, 24, 20, 16, 16},
};
...
static ISP_S32 fun_autoscene_sc202cs(ISP_DEV IspDev,ISP_EXT_AUTOSCENE_FUN_PARA_S *pstPara, AUTOSCENE_PARA_ADDR_S stAddr)
{
	...
	switch(pstPara->au32Rsv[0])
	{
		...
		default:
			...
			{
				stSharpenAttr.stCom.au16TabEdge[u8i] = gau16SharpTab_sc202cs[0][u8i];
				stSharpenAttr.stCom.au16TabText[u8i] = gau16SharpTab_sc202cs[1][u8i];
				stSharpenAttr.stCom.au16TabLum[u8i] = gau16SharpTab_sc202cs[2][u8i];
			}
...
{	
	...
	else
	{
		...
		pstAutoSceneDn->stAePara.au8AeLumColor[2] = 36;
		pstAutoSceneDn->stAePara.au8AeLumColor[3] = 28;
	...
	switch(stProductInfo.u8FunExt)
	{
		...
		case FUN_EXT_DOOR_LOCK_FACE_UVC:
			stChromaAttr.enHue2Sel = HUE_SEL_GREEN;
			stChromaAttr.s16Hue2Ofst = 0x00;
			stChromaAttr.u8SthPu = 0x50;
			stChromaAttr.u8SthR = 0x60;
			...
			stWBAttr.stManual.u16Rgain = 510;
			stWBAttr.stManual.u16Bgain = 431;
			//stWBAttr.enOpType = OP_TYPE_MANUAL;
			pstExpAttr.stManual.u32ExpLine = 1500;
			pstExpAttr.stManual.s32AGain = 0x2000;
			pstExpAttr.stManual.s32DGain = 0x400;
