...
{	
	...
	else
	{
		...
		pstAutoSceneDn->stAePara.au8AeLumColor[1] = 48;
		pstAutoSceneDn->stAePara.au8AeLumColor[2] = 46;
		...
		pstAutoSceneDn->stAePara.au8AeStrategyStrDef[0] = 0x40;
		pstAutoSceneDn->stAePara.au8AeStrategyDef[1] = AE_EXP_LOWLIGHT_PRIOR;
		pstAutoSceneDn->stAePara.au8AeStrategyStrDef[1] = 0x40;
