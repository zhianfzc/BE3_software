...
//#define RGB_MIRROR
//#define UVC_IR_NO
//#define RGB_HORI_IR_VERT   // zcy open this tag for daping
...
//#define PLANTFORM_XM530V202 //zcy note be3y-t


#ifdef PLANTFORM_XM530V202
#define REGS_RLED_ADDR		0x10020034
#define REGS_AO_EN_ADDR		0x1002002C
#else
...
enum RESOLUTION_INFO_E
{
	...
	RESOLUTION_INFO_640_480 = 2, 	/* 1.640x480 2.480x320 3.800x480 4.720P 5.1280x480 */
	RESOLUTION_INFO_800_480 = 3, 	/* 1.800x480 2.720P 3.640x480 4.480x320 5.1280x480 */
	RESOLUTION_INFO_864_480 = 4,	/* 1.864x480 2.800x480 3.640x480 4.480x320 5.1280x480 */
	RESOLUTION_INFO_720P = 5,		/* 1.720P 2.800x480 3.640x480 4.480x320 5.1280x480 */
	RESOLUTION_INFO_720P_1 = 6,		/* 1.720P 2.864x480 3.800x480 4.640x480 5.480x320  */
	RESOLUTION_INFO_720P_2 = 7,		/* 1.720P 2.864x480 3.800x480 4.640x480 5.1280x480 */
	RESOLUTION_INFO_480_864 = 8,	/* 1.480x864 2.480x800 3.480x320 4.320x240 5.1280x480 */
	RESOLUTION_INFO_854_480 = 9,	/* 1.480x320 2.320x240 3.800x480 4.854x480 5.720P */
};
