...
/*************************************************************************
º¯Êý¹¦ÄÜ:		²ÎÊý³õÊ¼»¯
ÊäÈë²ÎÊý: 		u32ProductType:  ²úÆ·ÐÍºÅ£¨ÓÃÓÚÇø·Ö²»Í¬²úÆ·£©
Êä³ö²ÎÊý:		stAddr:   		ÅäÖÃÏà¹Ø
·µ»Ø²ÎÊý: 		0:³É¹¦    		-1:Ê§°Ü
note:
*************************************************************************/
...
{	
	...
	else
	{
		...
		pstAutoSceneDn->stAePara.au8AeLumColor[0] = 62;
		pstAutoSceneDn->stAePara.au8AeLumColor[1] = 56;
		pstAutoSceneDn->stAePara.au8AeLumColor[2] = 56;
		pstAutoSceneDn->stAePara.au8AeLumColor[3] = 46;
	...
	switch(stProductInfo.u8FunExt)
	{
		...
		case FUN_EXT_DOOR_LOCK_FACE_UVC:
			stChromaAttr.enHue2Sel = HUE_SEL_GREEN;
			stChromaAttr.s16Hue2Ofst = 0x00;
			stChromaAttr.u8SthPu = 0x60; //zcy add
			stChromaAttr.u8SthR = 0x60; //zcy md 70 to50
			stChromaAttr.u8SthYe = 0x60;
			stChromaAttr.u8SthG = 0x50;
			stChromaAttr.u8SthCy = 0x60;
			stChromaAttr.u8SthB = 0x40;
			stWBAttr.stAuto.u8ROfst = 123;
			stWBAttr.stAuto.u8BOfst = 0x85;//zcy md84 to 80~
			stWBAttr.stAuto.u8GmOfst = 120; //zcy md 117 to 122
